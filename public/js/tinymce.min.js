...
tinymce.baseURL = "https://cdn.tiny.cloud/1/no-api-key/tinymce/4.9.11-99"
...
!function(){"use strict";function o(){}function c(){return(new Date).getTime()}function t(t,n){var r,i,e,n=(r=t,i=n,{send:function(t,n,e){var t="?aid="+i+"&tna=tinymce_cloud&p=web&dtm="+n+"&stm="+c()+"&tz="+("undefined"!=typeof Intl?encodeURIComponent(Intl.DateTimeFormat().resolvedOptions().timeZone):"N%2FA")+"&e=se&se_ca="+t,o=document.createElement("img");o.src=r.chiffer_snowplow_service_url+t;t=function(t){return function(){o.onload=null,o.onerror=null,e(t)}};o.onload=t(!0),o.onerror=t(!1)}});return e=n,{sendStat:function(t){return function(){e.send(t,c(),o)}}}}var e,n,r,i,u,a=(e="string",function(t){return t=typeof(n=t),(null===n?"null":"object"==t&&(Array.prototype.isPrototypeOf(n)||n.constructor&&"Array"===n.constructor.name)?"array":"object"==t&&(String.prototype.isPrototypeOf(n)||n.constructor&&"String"===n.constructor.name)?"string":t)===e;var n});r=tinymce.defaultSettings,i={load:o},u=function(t){t=t.api_key;return a(t)?t:void 0}(r),i=void 0===u?i:((n=t(r,u)).sendStat("script_load")(),{load:function(t){t.once("init",n.sendStat("init")),t.once("focus",n.sendStat("focus")),t.on("ExportPdf",n.sendStat("export_pdf"))}}),tinymce.PluginManager.add("chiffer",i.load)}();